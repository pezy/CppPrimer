...
//! takes
//! a pair of iterators denoting an input range and a predicate that it applies
//! to each
//! element in the given range. count_if returns a count of how often the
//! predicate is
//! true. Use count_if to rewrite the portion of our program that counted how
//! many words
...
//! variable until
//! it reaches 0. Once the variable is 0 additional calls should no longer
//! decrement the
...
{
    //! ex10.20
    vector<string> v{"alan",    "moophy",  "1234567",
    ...
    std::cout << "ex10.21: ";
    while (!check_and_decrement()) std::cout << i << " ";
    std::cout << i << std::endl;
